--1.Soru : film tablosunda bulunan tüm sütunlardaki verileri 
...
--2.Soru : actor tablosunda bulunan first_name ve last_name sütunlardaki verileri 
--first_name 'Penelope' veya 'Nick' veya 'Ed' değerleri olması koşuluyla sıralayınız. ( IN operatörünü kullanınız.)
select * from public.actor 
where first_name IN('Penelope', 'Nick', 'Ed');

--3.Soru : film tablosunda bulunan tüm sütunlardaki verileri rental_rate 0.99, 2.99, 4.99 
